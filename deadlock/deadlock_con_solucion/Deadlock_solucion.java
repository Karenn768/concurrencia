...
public class Deadlock_solucion {
    ...
    private static final Condition recursoDisponible = banqueroLock.newCondition();
    ...
    public static AtomicInteger transferenciasExitosasBanquero = new AtomicInteger(0);
    ...
    public synchronized void reiniciarSaldo(double nuevoSaldo) {
        this.saldo = nuevoSaldo;
    }
    
    // ═════════════════════════════════════════════════════════════════════════════
    // ALGORITMO 1: PREVENCIÓN DE DEADLOCK (Programación defensiva)
    // ═════════════════════════════════════════════════════════════════════════════
    ...
    // ═════════════════════════════════════════════════════════════════════════════
    // ALGORITMO 2: EVITACIÓN DE DEADLOCK (Algoritmo del Banquero)
    // ═════════════════════════════════════════════════════════════════════════════
    ...
    public static void main(String[] args) {
        ...
        // ═════════════════════════════════════════════════════════════════════════════
        // ALGORITMO 1: PREVENCIÓN DE DEADLOCK (Ordenamiento de recursos)
        // ═════════════════════════════════════════════════════════════════════════════
        System.out.println("\n\n═══════════════════════════════════════════════════════════════════════════════════════════════════");
        System.out.println("                   ALGORITMO 1: PREVENCIÓN DE DEADLOCK Profgramación defensiva");
        ...
        System.out.println("\n═══════════════════════════════════════════════════════════════════════════════════════════════════");
        System.out.println("                                RESUMEN ALGORITMO 1");
        ...
        for (int i = 0; i < 5; i++) {
            ...
            cuentas[i].reiniciarSaldo(saldoInicial);
        ...
        System.out.println("─────────────────────────────────");
        double totalFinalBanquero = 0;
        for (int i = 0; i < 5; i++) {
            double saldo = cuentas[i].getSaldo();
            System.out.printf("  Cuenta %d: $%-6.0f\n", i, saldo);
            totalFinalBanquero += saldo;
        }
        System.out.println("─────────────────────────────────");
        System.out.printf("  Total:    $%-6.0f\n", totalFinalBanquero);
